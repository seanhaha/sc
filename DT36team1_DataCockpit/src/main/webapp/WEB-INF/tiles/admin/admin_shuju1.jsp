    ...
    <div class="modal-dialog modal-sm" style="width: 40%">  
        ...
        <form action="" method="get">   
            ...
            <div class="modal-body">  
                    ...
                    <div class="form-group">  
                        <table width="100%" border="1px" cellspacing="0px" cellpadding="0px" id="tb1"  class="table  table-bordered">
                          <tr>
                            <td>编号</td>
                            <td>显示名称</td>
                            <td>字段属性</td>
...
<!--                           </tr> -->
							 ...
							 <div id="addtrdiv" style="margin-top:-15px;width: 15%; float: right;">  
							    <button type="button" class="btn btn-xs btn-link" id="add">添加</button>  
							</div> 
							                    </div>  
